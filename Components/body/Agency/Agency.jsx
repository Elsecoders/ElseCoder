      ...
      <div className="agency mt-5 ">
        ...
        <div className="service-box">
          <Card style={{width:"18rem", height:"18rem" }} className="card-1">
                ...
                <Card.Body>
                <ShoppingBasketOutlinedIcon style={{color:"#111", marginRight:"220px", height:"2.5rem"}}/>
            ...
            <Card style={{width:"18rem", height:"18rem" }} className="card-2">
                ...
                <Card.Body>
                <AssignmentOutlinedIcon style={{color:"#111", marginRight:"220px", height:"2.5rem"}}/>
            ...
            <Card style={{width:"18rem", height:"18rem" }} className="card-3">
                ...
                <Card.Body>
                <DashboardCustomizeOutlinedIcon style={{color:"#111", marginRight:"220px", height:"2.5rem"}}/>
