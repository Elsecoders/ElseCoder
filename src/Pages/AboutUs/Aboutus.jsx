...
const Aboutus = () => {
  ...
  <div className="about-tag">
    ...
    <p className="about-para">
      ...
      towards its immediate and long-term objectives. As a company, we specialize
      <br /> in developing fully-fledged, highly reliable, and extensible
      applications. Our ultimate objective is to provide you with a high-quality
      web <br />
      application that efficiently uses your resources while remaining
      affordable.
      <br /> <br />
      No matter what you need, we can provide a scalable, user-friendly solution
      to help your organization run more smoothly and effectively now and in
      <br /> the future. With our years of relevant experience, we can help you
      dethrone your competitors and increase your revenue.
    </p>
  </div>
        <div className="about-mission">
          <div>
            <h3 className="mission-head"><b>Mission And Vision</b></h3>
          </div>
