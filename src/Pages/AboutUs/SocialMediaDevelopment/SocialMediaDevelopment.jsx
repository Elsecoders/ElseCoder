...
import "./SocialMediaDevelopment.css";
...
const SocialMediaDevelopment = () => {
  ...
  const technologyContent = {
    ...
    java: {
      head: "Java",
      description:
        "We offer SMBs, startups, and enterprises, innovation to digitize their businesses, through our expertise in Java for mobile apps, game apps, and much more.<br /> <br /> Java is the easiest official language to work with when developing your first mobile app from our best mobile app development company in USA.",
      image: "../../../../../public/Images/aboutUs/javalogo.png",
    },
    kotlin: {
      head: "Kotlin",
      description:
        "With a diverse team of programmers, we offer exceptional skills in Kotlin and other programming languages to design innovative solutions for startups, enterprises, and Fortune 500s.<br /> <br /> Kotlin works well for cross-platform applications, allowing businesses to target both Android and iOS simultaneously.",
      image: "../../../../../public/Images/aboutUs/kotlin-logo-2.png",
    },
    javascript: {
      head: "Javascript",
      description:
        "Whether it’s a website or a web app, our designers and developers have experience in designing exceptional solutions using HTML5 and other web programming languages.<br /> <br /> With new elements and attributes, HTML5 offers more creative freedom for designers to craft your app as you imagined it.",
    ...
    objectivec: {
      head: "Objective C",
      description:
        "To help startups and enterprises launch an app on the iOS platform, Mac OS, or iPad, Cubix provides a development team specializing in iOS app development.<br /> <br /> Objective C is a general-purpose, object-oriented language that offers convenience and flexibility in design and development.",
            ...
            <div className="first-container-text">
              <div>
                ...
                <p>
                  ...
                  services to our diverse clientele spanning all major
                  industries.
                </p>
              </div>
                ...
                <div className="nav tabs-nav" role="tablelist">
                  ...
                  >
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/javalogo.png"
                        alt="java-logo"
                      />
                    </li>
                    <li
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/kotlin-logo-2.png"
                        alt="kotlin-logo"
                      />
                    </li>
                    <li
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/js-logo.png"
                        alt="javascript-logo"
                      />
                    </li>
                  </ul>
                ...
                <div className="nav tabs-nav" role="tablelist">
                  ...
                  >
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/swift-logo.png"
                        alt="swift-logo"
                      />
                    </li>
                    <li
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/objective-c.png"
                        alt="objectivec-logo"
                      />
                    </li>
                  </ul>
                ...
                <div className="nav tabs-nav" role="tablelist">
                  ...
                  >
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/mangoDb.png"
                        alt="mongodb"
                      />
                    </li>
                    <li
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/mysql.png"
                        alt="mysql"
                      />
                    </li>
                  </ul>
                ...
                <div className="nav tabs-nav" role="tablelist">
                  ...
                  >
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/icons8-react-80.png"
                        alt="react"
                      />
                    </li>
                    <li
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/icons8-vue-js-48.png"
                        alt="vue"
                      />
                    </li>
                    <li
                    ...
                    >
                      <img
                        style={{ width: "40px" }}
                        src="../../../../../public/Images/aboutUs/icons8-node-js-48.png"
                        alt="node"
                      />
                    </li>
                  </ul>
              ...
              <div className="tabs-content mt-sm7">
                ...
                >
                  <div className="boxseo-data">
                    <img
                      src={technologyContent[selectedLanguage].image}
                      alt=""
                    />
                    ...
                    <p
                      dangerouslySetInnerHTML={{
                        __html:
                          technologyContent[selectedLanguage]?.description,
                      }}
                    ></p>
                  </div>
                </div>
